...
const IlluHome = () => (
  ...
  >
      ...
      return (
        <g key={i}>
          ...
          <rect
            x={30 + col * 88}
            y={54 + row * 36}
            width={55 * fills[i] * 0.45}
            height="3.5"
            rx="2"
            fill="rgba(84,186,96,0.35)"
          />
        </g>
      );
    })}
    ...
    <rect
      ...
      height="20"
      rx="4"
      fill="rgba(84,186,96,0.05)"
      stroke="rgba(84,186,96,0.14)"
      strokeWidth="0.5"
    />
    ...
    <rect
      ...
      height="6"
      rx="2"
      fill="rgba(66,114,184,0.3)"
    />
    {/* WAF / Antivirus badges */}
    <rect
      x="10"
      y="140"
      width="82"
      height="20"
      rx="4"
      fill="rgba(84,186,96,0.07)"
      stroke="rgba(84,186,96,0.18)"
      strokeWidth="0.5"
    />
    <rect
      x="100"
...
const IlluChat = () => (
  ...
  >
    ...
    <rect
      ...
      height="38"
      rx="12"
      fill="rgba(66,114,184,0.14)"
      stroke="rgba(66,114,184,0.28)"
      strokeWidth="0.5"
    />
    <polygon
      points="12,34 4,42 20,42"
      fill="rgba(66,114,184,0.14)"
      stroke="rgba(66,114,184,0.28)"
      strokeWidth="0.5"
    />
    ...
    <rect
      ...
      height="32"
      rx="12"
      fill="rgba(84,186,96,0.1)"
      stroke="rgba(84,186,96,0.24)"
      strokeWidth="0.5"
    />
    <polygon
      points="268,82 276,90 260,90"
      fill="rgba(84,186,96,0.1)"
      stroke="rgba(84,186,96,0.24)"
      strokeWidth="0.5"
    />
    ...
    <circle
      ...
      cy="38"
      r="20"
      fill="rgba(66,114,184,0.08)"
      stroke="rgba(66,114,184,0.2)"
      strokeWidth="0.5"
    />
    <circle
      cx="253"
      cy="38"
      r="9"
      fill="rgba(84,186,96,0.12)"
      stroke="rgba(84,186,96,0.35)"
      strokeWidth="0.8"
    />
    ...
    {[0, 45, 90, 135, 180, 225, 270, 315].map((deg) => {
      ...
      return (
        <line
          key={deg}
          x1={253 + 11 * Math.cos(r)}
          y1={38 + 11 * Math.sin(r)}
          x2={253 + 17 * Math.cos(r)}
          y2={38 + 17 * Math.sin(r)}
          stroke="rgba(84,186,96,0.4)"
          strokeWidth="0.8"
        />
      );
    })}
        ...
        {[0, 1, 2].map((b) => (
          <g key={b}>
            ...
            <rect
              x={t.x + 6}
              y={108 + b * 12}
              width={(t.w - 12) * (0.3 + i * 0.22 + b * 0.06)}
              height="8"
              rx="2"
              fill={`${t.col}55`}
            />
...
const IlluCustomImage = () => (
  ...
  >
    ...
    <rect
      ...
      height="36"
      rx="6"
      fill="rgba(66,114,184,0.18)"
      stroke="rgba(66,114,184,0.4)"
      strokeWidth="0.8"
    />
    <rect
      x="124"
    ...
    {/* Upload arrow */}
    <path
      d="M46 108 L46 75 Q46 64 56 62 L82 62"
      fill="none"
      stroke="rgba(84,186,96,0.38)"
      strokeWidth="1"
      strokeDasharray="4 3"
    />
    ...
    <rect
      ...
      height="40"
      rx="7"
      fill="rgba(84,186,96,0.06)"
      stroke="rgba(84,186,96,0.2)"
      strokeWidth="0.7"
    />
    <text
      x="47"
...
const IlluMonitoring = () => (
  ...
  >
    ...
    {/* Read IOPS area */}
    <path
      d="M30,116 C50,108 62,88 78,85 C94,82 105,97 124,89 C138,83 148,66 163,62 C178,58 188,70 208,66 C222,63 240,50 265,44 L265,142 L30,142 Z"
      fill="url(#im-r)"
    />
    <path
      d="M30,116 C50,108 62,88 78,85 C94,82 105,97 124,89 C138,83 148,66 163,62 C178,58 188,70 208,66 C222,63 240,50 265,44"
      fill="none"
      stroke="#4272B8"
      strokeWidth="1.8"
    />
    {/* Write IOPS area */}
    <path
      d="M30,130 C44,126 58,118 74,116 C88,114 102,122 118,114 C132,107 148,100 163,96 C178,92 194,100 214,95 C228,90 248,83 265,79 L265,142 L30,142 Z"
      fill="url(#im-w)"
    />
    <path
      d="M30,130 C44,126 58,118 74,116 C88,114 102,122 118,114 C132,107 148,100 163,96 C178,92 194,100 214,95 C228,90 248,83 265,79"
      fill="none"
      stroke="#54BA60"
      strokeWidth="1.8"
    />
...
const IlluNetwork = () => (
  ...
  >
    ...
    <rect
      ...
      height="150"
      rx="10"
      fill="rgba(38,74,159,0.05)"
      stroke="rgba(38,74,159,0.28)"
      strokeWidth="0.8"
      strokeDasharray="6 3"
    />
    {/* App subnet */}
    ...
    <rect
      ...
      height="124"
      rx="7"
      fill="rgba(38,74,159,0.07)"
      stroke="rgba(38,74,159,0.24)"
      strokeWidth="0.6"
    />
    <text
      x="204"
    ...
    {[0, 1, 2].map((i) => (
      <g key={i}>
        ...
        <rect
          ...
          width="56"
          height="14"
          fill="rgba(38,74,159,0.08)"
          stroke="rgba(66,114,184,0.12)"
          strokeWidth="0.4"
        />
        <ellipse
          cx="204"
      ...
      <g key={i}>
        ...
        {i < 3 && (
          <>
            ...
            />
            <polygon
              points={`${s.x + 78},51 ${s.x + 84},54 ${s.x + 78},57`}
              fill="rgba(255,255,255,0.14)"
            />
          </>
        )}
...
const IlluStorage = () => (
  ...
  >
    {/* Ceph hex cluster */}
    <polygon
      points="140,66 156,75 156,93 140,102 124,93 124,75"
      fill="rgba(66,114,184,0.18)"
      stroke="rgba(66,114,184,0.5)"
      strokeWidth="0.8"
    />
    <text
      x="140"
...
export const PLATFORM_FEATURES = [
  {
    ...
    bullets: [
      "دسترسی به Status Page و بررسی لحظه‌ای وضعیت عملیاتی و پایداری سرویس‌ها",
      "ورود به مستندات و راهنماهای فنی جهت نصب، راه‌اندازی و استقرار سرویس‌ها",
      "گفتگو با چت‌بات هوشمند ابرآمد و دریافت پاسخ سوالات در لحظه",
    ],
  ...
  },
  {
    ...
    shortDesc:
      "پاسخ‌گویی سریع و دقیق به سوالات سرویس‌ها و پلتفرم با هوش مصنوعی",
    descParagraphs: [
  ...
  },
  {
    ...
    shortDesc:
      "ایجاد ماشین مجازی از ایمیج‌های دلخواه با تنظیمات از پیش تعریف‌شده",
    descParagraphs: [
  ...
  },
  {
    ...
    shortDesc:
      "Multi-Subnet برای ایجاد زیرشبکه‌های ایزوله و معماری شبکه‌ای حرفه‌ای",
    descParagraphs: [
